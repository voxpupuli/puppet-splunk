...
describe 'splunkforwarder Fact' do
  before do
    Facter.clear
  end
  ...
  it 'returns version for Windows' do
    ...
    expect(Facter.fact(:splunkforwarder).value).to eq({'version' => '7.0.2','build' => '03bbabbd5c0f'})
  ...
  it 'returns {}' do
    ...
    expect(Facter.fact(:splunkforwarder).value).to eq({})
  end
end
